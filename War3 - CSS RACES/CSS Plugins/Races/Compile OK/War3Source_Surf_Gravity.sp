/**
* File: War3Source_surf_Gravity.sp
...
{
    name = "War3Source Race - Silver Surfer",
    author = "Remy Lebeau",
    description = "Low Gravity race for War3Surf",
    version = "1.0",
    url = "http://sevensinsgaming.com"
};


new Float:g_fGrav[] = { 1.0, 0.8, 0.7, 0.6, 0.5, 0.4 };
...
{
    thisRaceID=War3_CreateNewRace("Silver Surfer [SURF]","surf_gravity");
    
    SKILL1=War3_AddRaceSkill(thisRaceID,"Low Grav","Low Gravity",false,5);
    ...
    War3_AddSkillBuff(thisRaceID, SKILL1, fLowGravitySkill, g_fGrav);
