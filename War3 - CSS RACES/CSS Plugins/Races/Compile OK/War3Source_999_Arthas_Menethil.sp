...
public OnWar3PluginReady()
{
	...
	SKILL_IMMUNE = War3_AddRaceSkill( thisRaceID, "Knowledge of Uther Lightbringer", "Immune to ultimates", false, 4 );
	SKILL_DMG = War3_AddRaceSkill( thisRaceID, "Cult of the Damned", "Powers to destroy Damned Cult", false, 4 );
	SKILL_SPEED = War3_AddRaceSkill( thisRaceID, "Travel to Northrend", "Summon your mount and travel faster", false, 4 );
