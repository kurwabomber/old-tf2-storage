...
new thisRaceID;
/////////////////////////////////////////////////////////////////////////////////////////////////
// Knifes  инжалы (с каждым прокачиванием скила увеличиваетс€ количество метательных ножей)(6 уровней)
new SKILL_KNIFES; 
new g_iMaxDaggers[] = {0,2,4,6,8,10,12 };
/////////////////////////////////////////////////////////////////////////////////////////////////
// Steady Hand “верда€ рука(”величиваетс€ урон от ножей)(6 уровней)
new SKILL_STEADY; 
new g_iSteadyDamage[] = {40,50,60,70,80,90,100};
new g_iSteadyHsDamage[] = {90,100,110,120,130,140,150};
/////////////////////////////////////////////////////////////////////////////////////////////////
// powerful throw ћощный бросок (”величиваетс€ скорость полета ножей )(6 уровней)
new SKILL_THROW; 
new Float:g_flThrowVelocity[] = {1600.0,1800.0,2000.0,2200.0,2400.0,2600.0,2800.0};
/////////////////////////////////////////////////////////////////////////////////////////////////
//Ћегковес(увеличивает скорость передвижени€)
new SKILL_LIGHTWEIGHT;
new Float:g_flLightWeightSpeed[] = {1.0,1.1,1.2,1.3,1.4,1.5,1.6};
/////////////////////////////////////////////////////////////////////////////////////////////////
// —пр€татьс€ в тень (если игрок стоит на месте, то он становитс€ невидим,но при это бить и метать не может){с каждым прокачиванием уменьшаетс€ врем€,входа в инвиз}(6уровней)
new SKILL_SHADOW; 
new Float:g_flShadowTimer[] = {0.0,5.0,4.0,3.0,2.0,1.0};
new Float:caninvistime[MAXPLAYERS+1];
/////////////////////////////////////////////////////////////////////////////////////////////////
// ¬осстановление метательных ножей, с каждым прокачиванием увеличиваетс€ количество востановлени€ ножей
new ULT_RESTORE; 
