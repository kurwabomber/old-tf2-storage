...
public OnWar3PluginReady(){
	...
	SKILL_BOLT=War3_AddRaceSkill(thisRaceID,"Storm Bolt (Ability)","Do damage in an AoE and stun enemys",false,4);
	SKILL_CLEAVE=War3_AddRaceSkill(thisRaceID,"Great Cleave","Your attacks splash to nearby enemys",false,4);
	SKILL_WARCRY=War3_AddRaceSkill(thisRaceID,"Warcry","Passively gain armor and movement speed",false,4);
	ULT_STRENGTH=War3_AddRaceSkill(thisRaceID,"Gods Strength (Ultimate)","Greatly enhance your damage for a short amount of time.",true,4); 
