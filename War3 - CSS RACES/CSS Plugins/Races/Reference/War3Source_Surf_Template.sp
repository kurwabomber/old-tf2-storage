...
public OnWar3PluginReady()
{
    ...
    SKILL3=War3_AddRaceSkill(thisRaceID,"Pointless","Just here to make up levels...",false,5);
    ULT=War3_AddRaceSkill(thisRaceID,"Pointless","Just here to make up levels...",false,5);
